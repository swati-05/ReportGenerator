                ...
                <div>
                    <li onClick={() => menuClick()} className='ml-1 text-white text-left  '>
                        <button className=" text-gray-500 font-semibold py-2 px-4 rounded inline-flex items-center ">
                            ...
                            <label className='ml-3 text-xs  text-white hover:bg-sky-100 hover:text-[#074097]' value={props.menuGroupId}>{props.menuGroupName}</label>
                        </button>
                    </li>
                </div>
                                        ...
                                        <button className="  font-semibold   rounded inline-flex items-center ml-5 p-2">
                                            ...
                                            <ul>
                                                <Link to={`templateSubmenu/${data.submenu[0]?.type}/${data?.menu_name}/${data?.menu_code}/${props.menuGroupId}/${data?.menu_id}`} >
                                                    <li className='ml-3 text-sm text-[#074097]' onClick={menuClick} value={data.menu_id}>{data.menu_id}{data.menu_name}</li>
                                                </Link>
                                            </ul>
                                        </button>
                                    </div>
